...
${metadata.stylingApproaches.map((approach) => `### ${approach.approach}\n\n${approach.description}\n\n**Pros:**\n${list(approach.pros || [])}\n\n**Cons:**\n${list(approach.cons || [])}`).join('\n\n')}
...
${metadata.bestPractices.map((category) => `### ${category.category}\n\n${list(category.practices)}`).join('\n\n')}
