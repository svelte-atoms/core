...
export const passwordControlProps: PropDefinition[] = [
	...
	{ name: 'placeholder',   type: 'string',  default: "''",      description: 'Placeholder text.' },
	{ name: 'visible',       type: 'boolean', default: 'false',   description: 'Toggles password visibility.' },
	{ name: 'disabled',      type: 'boolean', default: 'false',   description: 'Disables the control.' },
	{ name: 'toggleContent', type: 'Snippet', default: 'built-in', description: 'Custom show/hide toggle button.' },
];
...
export const phoneControlProps: PropDefinition[] = [
	...
	{ name: 'format',   type: 'string',         default: "'+# (###) ###-####'", description: 'Mask pattern. # = required digit, [#] = optional.' },
	{ name: 'segments', type: 'PhoneSegmentMap', default: 'undefined',          description: 'Color map for segment highlighting.' },
	{ name: 'disabled', type: 'boolean',        default: 'false',               description: 'Disables the control.' },
];
...
export const currencyControlProps: PropDefinition[] = [
	...
	{ name: 'amount',    type: 'number', default: 'undefined', description: 'Bindable parsed numeric amount.' },
...
export const timeControlProps: PropDefinition[] = [
	{ name: 'value',       type: 'string',    default: "''",       description: 'Bindable time string (HH:mm or HH:mm:ss).' },
	{ name: 'date',        type: 'Date',      default: 'undefined', description: 'Bindable Date object (time portion).' },
...
export const dateControlProps: PropDefinition[] = [
	{ name: 'value', type: 'string', default: "''",       description: 'Bindable date string (YYYY-MM-DD).' },
...
export const colorControlProps: PropDefinition[] = [
	...
	{ name: 'format',   type: 'ColorFormat', default: "'auto'",   description: 'Override the active format.' },
	{ name: 'alpha',    type: 'boolean',     default: 'false',    description: 'Always show the alpha channel segment.' },
	{ name: 'oninput',  type: 'function',    default: 'undefined', description: 'Fires on every channel edit (live).' },
	{ name: 'onchange', type: 'function',    default: 'undefined', description: 'Fires on blur or Enter (commit).' },
];
...
export const otpControlProps: PropDefinition[] = [
	...
	{ name: 'type',       type: "'numeric' | 'alpha' | 'alphanumeric'", default: "'numeric'", description: 'Accepted character set.' },
	{ name: 'groupSize',  type: 'number',                              default: 'undefined', description: 'Visual grouping (gap every N slots).' },
	{ name: 'oncomplete', type: 'function',                            default: 'undefined', description: 'Fires once when all slots are filled.' },
];
...
export const fileControlProps: PropDefinition[] = [
	...
	{ name: 'triggerContent', type: 'Snippet', default: 'built-in',  description: 'Custom trigger button content.' },
];

export const locationControlProps: PropDefinition[] = [
	{ name: 'value',     type: 'string',          default: "''",       description: 'Bindable formatted coordinate string.' },
	...
	{ name: 'format',    type: "'dd' | 'dms'",    default: "'dd'",     description: 'Decimal degrees or degrees/minutes/seconds.' },
