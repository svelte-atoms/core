	...
	<div class="flex flex-col gap-3">
		...
		<div class="relative w-80">
			<Toast.Root
				...
				duration={0}
				class={['relative flex w-80 flex-col gap-1 rounded-md border border-border bg-card p-4 pr-8 shadow-md transition-opacity', !declarativeOpen && 'invisible']}
			>
				<Toast.Title class="text-sm font-medium leading-tight">Declarative toast</Toast.Title>
				<Toast.Description class="text-sm opacity-80">Fully owned by markup — no manager required.</Toast.Description>
	...
	<div class="flex flex-col gap-3">
		...
		<div class="relative w-80">
			<Toast.Root
				...
				class={['relative flex w-80 flex-col gap-1 rounded-md border border-border bg-card p-4 pr-8 shadow-md transition-opacity', !autoDismissOpen && 'invisible']}
			>
