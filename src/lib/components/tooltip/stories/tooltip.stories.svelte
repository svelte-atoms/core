	...
	{#snippet template(args)}
		<div class="bg-background bg-dot-grid flex h-screen w-full items-center justify-center">
			<Tooltip_.Root {...args}>
				...
				<Tooltip_.Content
					class="bg-foreground text-background rounded-md px-2.5 py-1.5 text-xs font-medium shadow-sm"
				>
					This is a tooltip
					<Tooltip_.Arrow />
				</Tooltip_.Content>
...
<Story name="Placements">
	<div
		class="bg-background bg-dot-grid flex h-screen w-full flex-col items-center justify-center gap-10"
	>
...
<Story name="With Rich Content">
	<div
		class="bg-background bg-dot-grid flex h-screen w-full flex-col items-center justify-center gap-8"
	>
		<p class="text-muted-foreground text-[11px] font-medium uppercase tracking-[0.25em]">
		...
		<div class="flex items-center gap-6">
			...
			<Tooltip_.Root placement="top" offset={8}>
				...
				<Tooltip_.Content
					class="bg-foreground text-background w-48 rounded-md px-3 py-2 text-xs shadow-sm"
				>
			...
			<Tooltip_.Root placement="top" offset={8}>
				...
				<Tooltip_.Content
					class="bg-foreground text-background flex items-center gap-2 rounded-md px-2.5 py-1.5 text-xs font-medium shadow-sm"
				>
					Save document
